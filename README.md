...
13 included medical VLM datasets across 4 specialties. 0 candidate and 1 excluded records are retained for auditability but omitted from the tables below.
...
| [IU X-Ray](https://openi.nlm.nih.gov/) | multi-view | description, report-generation | 4.0K reports | report | [![Download](https://img.shields.io/badge/Download-0969DA?style=flat-square&logo=download&logoColor=white)](https://openi.nlm.nih.gov/faq) [![Paper](https://img.shields.io/badge/Paper-000000?style=flat-square&logo=paper&logoColor=white)](https://pubmed.ncbi.nlm.nih.gov/27701286/) | Per-image Open-i terms; check source (open) |
