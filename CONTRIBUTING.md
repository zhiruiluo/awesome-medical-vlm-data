...
Follow the complete [record workflow](WORKFLOW.md). In brief: create a JSON-compatible YAML record in the appropriate `datasets/<domain>/` directory, validate it, then generate and commit the final report files.
